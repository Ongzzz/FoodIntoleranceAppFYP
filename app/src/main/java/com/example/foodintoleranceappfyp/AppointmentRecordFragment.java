...
public class AppointmentRecordFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(bundle!=null)
        {
            String status = bundle.getString("Appointment Status");
            ...
            collectionReference.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if(task.isSuccessful())
                    {
                        ...
                        {
                            if(documentSnapshot.getString("Patient Email").equals(userId) &&
                                    documentSnapshot.getString("Status").equals(status))
                            {
                        ...
                        if(!appointmentList.isEmpty())
                        {
                            ...
                            lv_appointmentList.setAdapter(new AppointmentListAdapter(appointmentList, getContext(), "My Appointment"));
                        }
